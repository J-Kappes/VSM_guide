...
\begin{wrapfigure}[12]{r}{0.43\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{v2man100}
    \end{center}
\end{wrapfigure}
...
\begin{wrapfigure}[9]{l}{0.53\textwidth}
    \begin{center}
        \includegraphics[max width=\textwidth]{s345ms_t}
    \end{center}
\end{wrapfigure}
...
\begin{wrapfigure}[15]{r}{0.49\textwidth}
    \begin{center}
        \includegraphics[max width=\textwidth]{sys345_t}
    \end{center}
\end{wrapfigure}
...
\begin{wrapfigure}[11]{l}{0.45\textwidth}
    \begin{center}
        \includegraphics[max width=\textwidth]{s345op_t}
    \end{center}
\end{wrapfigure}
...
\begin{wrapfigure}[18]{r}{0.49\textwidth}
    \begin{center}
        \includegraphics[max width=\textwidth]{s1o_t}
    \end{center}
\end{wrapfigure}
...
\begin{wrapfigure}[15]{r}{0.49\textwidth}
    \begin{center}
        \includegraphics[max width=\textwidth]{s12345et}
    \end{center}
\end{wrapfigure}
...
The \textcolor{M}{\textbf{Metasystem}} is composed of Systems 2, 3, 4 and 5.

\begin{tabular}{|p{0.12375\textwidth} | p{0.81\textwidth}|}
    \hline
